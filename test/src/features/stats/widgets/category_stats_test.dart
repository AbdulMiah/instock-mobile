...
void main() {
  testWidgets('Displays correct category stats', (tester) async {
    //Given
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
            body: CategoryStats(
                statsDto: statsDto1,
                dropdownCategory: "Stickers",
                updateCategory: updateCategory)),
      ),
    );

    //When
    final giveawaysFinder = find.text('Giveaways: 110');
    final damagedFinder = find.text('Damaged: 0');
    final restockedFinder = find.text('Restocked: 134');
